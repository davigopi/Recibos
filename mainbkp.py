...
class Main:
    def __init__(self, *args, **kwargs) -> None:
        ...
        name_arq = 'tableMerge.csv'
        arqtableMerge = path_tables / name_arq
        ...
        xp2 = '//*[@id="pnlBloco"]/div[6]/div/div[3]/div'  # cp entrega venda inici
        xp3 = '//*[@id="ui-datepicker-div"]/div[1]/a[1]'  # bt seta para esquerda
        xp4 = f'//*[@id="ui-datepicker-div"]/table/tbody/tr[{line}]/td[{column}]'
        xp5 = '//*[@id="ui-datepicker-div"]/div[3]/button[2]'  # bt fechar calend
        xp6 = '//*[@id="pnlBloco"]/div[6]/div/div[4]/div'  # cp entrega venda final
        xp7 = '//*[@id="btnConsultar"]'  # botao consultar
        xp8 = '//*[@id="btnGerarXls"]'  # botao de download
        listXpathSales = [
            xp0, xp1, xp2, xp3, xp4, xp5, xp6, xp3, xp4, xp5, xp7, xp8]
        ...
        for num in range(30):  # quantidade de campos comissões configuracao
            listCampoCotaPeriodoParcela.append([
                f'//*[@id="frm:pnlEsacalas"]/div[{str(num + 1)}]',  # cp 0 a 2 Fath
                ...
                f'//*[@id="frm:j_idt124:{num}:j_idt182_input"]',  # data venda inic
        ...
        headerDtPagamentoParcelas = [
            ...
            'D+ perido inicial', 'D+ dt inicial', 'D+ periodo final',
            'D+ dt final',
    ...
    def create_table_Cadastro_Consorciado():
        ...
        if new_table_Cadastro_Consorciado:
            ...
            driver.quit()
            table_Cadastro_Consorciado = create_table(
                table_Cadastro_Consorciado,
            ...
            table_Cadastro_Consorciado = load_table(arqTableCadastroConsorciado)

    def create_table_Cadastro_Funcionario():
        ...
        if new_table_Cadastro_Funcionario:
            ...
            driver.quit()
            table_Cadastro_Funcionario = create_table(
                table_Cadastro_Funcionario,
            ...
            table_Cadastro_Funcionario = load_table(arqTableCadastroFuncionario)
    ...
    def create_table_Cadastro_Ata():
        ...
        if new_table_Cadastro_Ata is True:
            ...
            table_Cadastro_Ata = create_table(
                table_Cadastro_Ata,
                arqTableCadastroAta)
    ...
    def create_table_Comissoes_Configuracao():
        ...
        if new_table_Comissoes_Configuracao:
            ...
            driver.quit()
            table_Comissoes_Configuracao = create_table(
                table_Comissoes_Configuracao,
                arqTableComissoesConfiguracao)
    ...
    def create_table_Comissoes_ConfigPagamento():
        ...
        if new_table_Comissoes_ConfigPagamento:
            ...
            table_Comissoes_ConfigPagamento = create_table(
                table_Comissoes_ConfigPagamento,
                arqTableComissoesConfigPag)
    ...
    def merge_consorciado_funcionario():
        if mix:
            ...
            table_full = load_table(arqtableMerge)
    ...
    log_start_end()
    create_table_Cadastro_Consorciado()
    create_table_Cadastro_Funcionario()
    create_table_Cadastro_Ata()
    create_table_Comissoes_Configuracao()
    create_table_Comissoes_ConfigPagamento()
    date_weekly_new()
