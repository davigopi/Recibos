    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        for cargo_gerente in list_cargo_gerente:
            list_administrador = [
                ...
                'EMBRACONIMOVEL',
                'VOLKS',
                'EMBRACO IMOVEIS E VOLKS (DIFERENCIADA)']
            list_cargo_gerente = add_valor_list([cargo_gerente], 4)
            list_cargo_gerente_geral = add_valor_list(['GERENTE GERAL'], 4)
            list_periodo_valor_qtd_vendas_gerente_1 = add_valor_list(
                ['Período Venda: 01/01/2000 à 31/03/2034 - Valor Vendas: 0,00 à 1.999.999,99'], 4)  # noqa
            list_periodo_valor_qtd_vendas_gerente_2 = add_valor_list(
                ['Período Venda: 01/01/2000 à 31/03/2034 - Valor Vendas: 2.000.000,00 à 4.999.999,99'], 4)  # noqa
            list_periodo_valor_qtd_vendas_gerente_3 = add_valor_list(
                ['Período Venda: 01/01/2000 à 30/04/2034 - Valor Vendas: 5.000.000,00 à 6.999.999,99'], 4)  # noqa
            list_periodo_valor_qtd_vendas_gerente_4 = add_valor_list(
                ['Período Venda: 01/01/2000 à 30/04/2034 - Valor Vendas: 7.000.000,00 à 9.999.999,99'], 4)  # noqa
            list_periodo_valor_qtd_vendas_gerente_5 = add_valor_list(
                ['Período Venda: 01/01/2000 à 30/04/2034 - Valor Vendas: 10.000.000,00 à 99.999.999,99'], 4)  # noqa
            qtd_cotas_inicial_gerente_1 = add_valor_list([0], 4)
            qtd_cotas_inicial_gerente_2 = add_valor_list([2000000], 4)
            qtd_cotas_inicial_gerente_3 = add_valor_list([5000000], 4)
            qtd_cotas_inicial_gerente_4 = add_valor_list([7000000], 4)
            qtd_cotas_inicial_gerente_5 = add_valor_list([10000000], 4)
            qtd_cotas_final_gerente_1 = add_valor_list([1999999.99], 4)
            qtd_cotas_final_gerente_2 = add_valor_list([4999999.99], 4)
            qtd_cotas_final_gerente_3 = add_valor_list([6999999.99], 4)
            qtd_cotas_final_gerente_4 = add_valor_list([9999999.99], 4)
            qtd_cotas_final_gerente_5 = add_valor_list([999999999.99], 4)
            data_inicial_gerente = add_valor_list(['01/01/2000'], 4)
            data_final_gerente = add_valor_list(['31/03/2034'], 4)
            parc_gerente_1 = ['', '', '', '', 0.015]
            parc_gerente_2 = ['', '', '', 0.05, 0.015]
            parc_gerente_3 = [0.05, 0.05, '', '', 0.015]
            parc_gerente_4 = [0.05, 0.05, 0.05, 0.05, 0.015]
            parc_gerente_5 = [0.07, 0.07, 0.07, 0.05, 0.015]
            parc_gerente_6 = [0.09, 0.09, 0.09, 0.05, 0.015]
            parc_gerente_7 = [0.1, 0.1, 0.1, 0.05, 0.015]
